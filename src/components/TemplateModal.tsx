...
const TEMPLATES: Template[] = [
  {
    ...
    description: 'SEO-optimized README for a small npm package',
    ...
    blocks: [
      ...
      { id: id(), type: 'paragraph', props: { text: 'A short, keyword-rich description of what this library does and who it\'s for. Mention the primary use case and key differentiator.' } },
      { id: id(), type: 'heading', props: { level: 2, text: 'Why my-library?' } },
      { id: id(), type: 'list', props: { style: 'unordered', items: [
        { text: '**Zero dependencies** -- keeps your bundle small' },
        { text: '**TypeScript-first** -- full type inference, no `@types` needed' },
        { text: '**Tree-shakeable** -- only import what you use' },
      ] } },
      { id: id(), type: 'heading', props: { level: 2, text: 'Installation' } },
      ...
      { id: id(), type: 'heading', props: { level: 2, text: 'API Reference' } },
      ...
      { id: id(), type: 'gitshow', props: { username: 'ofershap' } },
  ...
  {
    name: 'Full Project',
    description: 'SEO & GEO optimized with all key sections',
    icon: <Wrench size={20} />,
    blocks: [
      ...
      { id: id(), type: 'paragraph', props: { text: '> A concise summary of what this project does, who it\'s for, and why it exists. Search engines and AI assistants extract this as the project description.' } },
      { id: id(), type: 'image', props: { url: 'https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=800&h=400&fit=crop&crop=top', alt: 'My Project demo showing the main interface with live preview and drag-and-drop editor', align: 'center', width: '600' } },
      { id: id(), type: 'heading', props: { level: 2, text: 'Why My Project?' } },
      { id: id(), type: 'paragraph', props: { text: 'Explain the problem this solves. AI search engines surface projects that clearly state the pain point and how they address it.' } },
      { id: id(), type: 'heading', props: { level: 2, text: 'Features' } },
      { id: id(), type: 'list', props: { style: 'unordered', items: [
        { text: '**Feature one** -- describe the benefit, not just the capability' },
        { text: '**Feature two** -- use keywords people would search for' },
        { text: '**Feature three** -- mention relevant technologies (React, TypeScript, etc.)' },
      ] } },
      { id: id(), type: 'heading', props: { level: 2, text: 'Installation' } },
      ...
      { id: id(), type: 'heading', props: { level: 2, text: 'Frequently Asked Questions' } },
      { id: id(), type: 'details', props: { summary: 'How does this compare to [alternative]?', content: 'Explain the key differences. AI assistants frequently surface FAQ sections when comparing tools.', open: false } },
      { id: id(), type: 'details', props: { summary: 'Does it work with [framework]?', content: 'Yes/no and how. Answering common questions here helps both SEO and GEO discoverability.', open: false } },
  ...
  {
    name: 'CLI Tool',
    description: 'SEO-optimized README for a command-line tool',
    ...
    blocks: [
      ...
      { id: id(), type: 'heading', props: { level: 2, text: 'Why my-cli?' } },
      { id: id(), type: 'paragraph', props: { text: 'Describe the problem this CLI solves and why someone would choose it over alternatives. This section is critical for AI search discoverability.' } },
      { id: id(), type: 'heading', props: { level: 2, text: 'Installation' } },
      ...
      { id: id(), type: 'heading', props: { level: 2, text: 'Frequently Asked Questions' } },
      { id: id(), type: 'details', props: { summary: 'Can I use this with CI/CD pipelines?', content: 'Yes -- my-cli works in any CI environment. See the [CI guide](docs/ci.md) for examples with GitHub Actions, GitLab CI, and Jenkins.', open: false } },
      { id: id(), type: 'heading', props: { level: 2, text: 'Author' } },
      { id: id(), type: 'gitshow', props: { username: 'ofershap' } },
      { id: id(), type: 'socialLinks', props: { links: [
        { platform: 'LinkedIn', handle: 'ofershap', url: 'https://linkedin.com/in/ofershap' },
  ...
  },
  {
    ...
    blocks: [
      ...
      { id: id(), type: 'image', props: { url: 'https://github-readme-stats.vercel.app/api?username=yourusername&show_icons=true&theme=dark', alt: 'GitHub contribution stats showing commit activity and language breakdown', align: 'left' } },
      { id: id(), type: 'heading', props: { level: 2, text: '🔗 Connect' } },
      { id: id(), type: 'gitshow', props: { username: 'ofershap' } },
      { id: id(), type: 'socialLinks', props: { links: [
        { platform: 'LinkedIn', handle: 'ofershap', url: 'https://linkedin.com/in/ofershap' },
        { platform: 'X/Twitter', handle: 'ofershap', url: 'https://x.com/ofershap' },
