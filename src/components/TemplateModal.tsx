...
const TEMPLATES: Template[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      { id: id(), type: 'buttonRow', props: { buttons: [
        { label: 'LinkedIn', url: 'https://linkedin.com/in/yourprofile', color: '0077B5', style: 'for-the-badge' },
        { label: 'Twitter', url: 'https://twitter.com/yourhandle', color: '1DA1F2', style: 'for-the-badge' },
        { label: 'Blog', url: 'https://yourblog.dev', color: '00C853', style: 'for-the-badge' },
      ], align: 'center' } },
    ],
  },
];
